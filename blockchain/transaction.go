...
//Hash is a method we can use to set the transaction ID as the hash
...
//Serialize does just that on the transaction block
...
//Sign will allow us to sign each transaction
...
//TrimmedCopy trims a transaction and returns it
...
//String converts transaction to a string
